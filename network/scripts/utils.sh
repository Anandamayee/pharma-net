...
PEER0_RETAILER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/reatailer.pharma-network.com/peers/peer0.reatailer.pharma-network.com/tls/ca.crt
